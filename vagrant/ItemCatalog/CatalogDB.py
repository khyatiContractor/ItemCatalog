...
catalogItem21 = CatalogItem(user_id=1, name="Shoes ", description="Unlined leather offers the maximum amount of comfort and ensures the shoes will mold to your feet. Synthetic overlay and lace closure system guarantees fit and performance for the gym and outside on the rock",
                     price="$70.99", catalog=catalog2)
session.add(catalogItem21)
session.commit()

catalogItem22 = CatalogItem(user_id=1, name="Ropes",
