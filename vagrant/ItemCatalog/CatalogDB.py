...
catalogItem21 = CatalogItem(user_id=1,
                            name="Shoes ",
                            description="Unlined leather offers the maximum amount of comfort and ensures the shoes will mold to your feet. Synthetic overlay and lace closure system guarantees fit and performance for the gym and outside on the rock",
                            price="$70.99",
                            catalog=catalog2)
...
catalogItem23 = CatalogItem(user_id=1,
                            name="Chalk Bags",
                            description="Blend of tough nylon fabrics endures regular encounters with rock; polyester fleece-lined interior helps contain chalk. Loop on side stows a brush for cleaning holds (brush not included). External zippered pocket stows small essentials, such as tape or a knife. Integrated bottle opener helps you unwind after a hard day of climbing. Drawstring with cordlock closes chalk bag when not in use ",
                            price="35",
                            catalog=catalog2)
...
catalogItem32 = CatalogItem(user_id=1,
                            name="Cycling shoes",
                            description="ompatible with single-release SPD cleats (note: SPD cleats are necessary to connect to a bike and are sold separately). Recessed plate makes walking on floors easier. Adjustable hook-and-loop straps offer midfoot support. Synthetic, no-sew overlays offer support from start to finish",
                            price="$126.99",
                            catalog=catalog3)
...
catalogItem42 = CatalogItem(user_id=1,
                            name="Props",
                            description="Made from 50 - 75% recycled post-industrial and post-consumer EVA foam; firm foam has a grippy feel. Use the block to support back bends or place it under your hands in standing poses. Edges are rounded for comfort",
                            price="$15.99",
                            catalog=catalog4)
